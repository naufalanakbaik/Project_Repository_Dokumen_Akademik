...
<head>
    ...
    <title>Mahasiswa - {{ config('app.name', 'Academic Repository') }}</title>
...
<body class="bg-slate-50 text-slate-900">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col">
            <div class="p-6">
                <h1 class="text-xl font-bold text-indigo-600">RepoDokumen <span class="text-xs font-normal text-slate-400">Mahasiswa</span></h1>
            </div>
        ...
        <main class="flex-1 flex flex-col">
            <header class="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between">
                ...
                <div class="hidden md:block">
                    <h2 class="text-lg font-semibold text-slate-800">@yield('title', 'Mahasiswa Dashboard')</h2>
                </div>
