        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="group bg-white p-5 rounded-lg border border-gray-300 shadow-sm hover:shadow-md transition">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span
                        class="material-symbols-outlined !text-[25px] text-gray-600 group-hover:text-gray-700 transition">description</span>
                </div>
            ...
            <div class="group bg-white p-5 rounded-lg border border-gray-300 shadow-sm hover:shadow-md transition">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span
                        class="material-symbols-outlined !text-[25px] text-green-600 group-hover:text-green-700 transition">verified</span>
                </div>
            ...
            <div class="group bg-white p-5 rounded-lg border border-gray-300 shadow-sm hover:shadow-md transition">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span
                        class="material-symbols-outlined !text-[25px] text-yellow-600 group-hover:text-yellow-700 transition">schedule</span>
                </div>
        ...
        <div class="bg-white rounded-lg border border-gray-300 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <a href="{{ route('mahasiswa.documents.index') }}"
                    ...
                    Lihat semua
                    <span class="material-symbols-outlined !text-[20px]">read_more</span>
                </a>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-start gap-3">
                                        <span class="material-symbols-outlined text-gray-500 mt-1">description</span>
                                        <div>
