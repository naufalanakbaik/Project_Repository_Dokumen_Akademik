...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-6">
    ...
    <div class="absolute top-3 left-4 flex items-center gap-3">
        <img src="{{ asset('img/logo-img/logo-unsri.png') }}" class="h-[55px] sm:h-[45px]" />
    ...
    <!-- Main Container -->
    <div class="w-full max-w-4xl min-h-[470px] bg-white border border-gray-300 rounded-lg shadow-md flex overflow-hidden">

        {{-- Left Content --}}
        <div class="hidden md:flex w-[50%] bg-gray-100 border-r border-gray-300 p-8">
        ...
        <!-- Right Content -->
        <div class="w-full md:w-[55%] flex items-center justify-center p-9">
            <div class="w-full max-w-md space-y-6">
                ...
                <form method="POST" action="/login" class="space-y-5">
                    ...
                    <!-- Email -->
                    <div class="space-y-1">
                        <label class="text-sm font-normal text-gray-800 pl-2.5">Email</label>
