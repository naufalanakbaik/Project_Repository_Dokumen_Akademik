...
<div class="space-y-5 pb-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-1">
        <div>
            <div class="flex items-center gap-1.5 text-xs text-gray-400 mb-1.5">
                ...
                <span class="text-gray-600 font-medium">Daftar Mahasiswa</span>
            </div>
            <h1 class="text-xl font-semibold text-gray-900 tracking-tight">Daftar Mahasiswa</h1>
    ...
    <div class="card px-5 py-4">
        <form method="GET" action="{{ route('kaprodi.users.mahasiswa') }}" class="flex flex-col md:flex-row items-stretch md:items-center gap-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <a href="{{ route('kaprodi.users.mahasiswa.show', $item->id) }}" class="font-medium text-gray-900">
                                        {{ $item->name }}
                                    </a>
                                </div>
                            </td>
