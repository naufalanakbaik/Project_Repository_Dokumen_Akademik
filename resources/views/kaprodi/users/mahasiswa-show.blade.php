...
<div class="space-y-5 pb-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-1.5 text-xs text-gray-400">
            ...
            <a href="{{ route('kaprodi.users.mahasiswa') }}" class="hover:text-gray-600 transition">Daftar Mahasiswa</a>
            <span class="material-symbols-outlined !text-[13px]">chevron_right</span>
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-3 mt-1 text-sm text-gray-400 flex-wrap">
                    ...
                    @endif
                    @if($user->angkatan)
                    <span class="badge badge-gray">Angkatan {{ $user->angkatan }}</span>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="card px-6 py-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                <p class="meta-label">NIM</p>
                <p class="meta-value">{{ $user->nim ?? '—' }}</p>
            </div>
            <div>
                <p class="meta-label">Angkatan</p>
                <p class="meta-value">{{ $user->angkatan ?? '—' }}</p>
            </div>
            <div>
                <p class="meta-label">Jurusan</p>
                <p class="meta-value">{{ $user->jurusan ?? '—' }}</p>
            </div>
            <div>
                <p class="meta-label">Bergabung</p>
                            ...
                            <td colspan="6" class="py-16 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-300 mt-0.5">Dokumen akan muncul setelah mahasiswa mengunggah</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
