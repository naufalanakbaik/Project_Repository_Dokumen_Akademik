...
@section('content')
    <div class="space-y-5 pb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-1">
            <div>
                <div class="flex items-center gap-1.5 text-xs text-gray-400 mb-1.5">
                    ...
                    <span class="text-gray-700 font-medium">Daftar Dosen</span>
                </div>
                <h1 class="text-[22px] font-semibold text-gray-900 tracking-tight">Daftar Dosen</h1>
                <p class="text-[13px] text-blue-500">Pantau data dan aktivitas unggah dokumen seluruh dosen</p>
            </div>
        ...
        <div class="card px-5 py-4">
            <form method="GET" action="{{ route('kaprodi.users.dosen') }}"
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari nama, email, atau NIP dosen..." class="input-field pl-9">
                </div>
                        ...
                        @forelse($dosen as $i => $item)
                            <tr>
                                <td class="text-xs text-gray-300 font-mono">
                                    {{ str_pad($dosen->firstItem() + $i, 2, '0', STR_PAD_LEFT) }}</td>
                                <td>
                                    <div class="flex items-center gap-2.5">
                                        <div
                                            class="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('kaprodi.users.dosen.show', $item->id) }}"
