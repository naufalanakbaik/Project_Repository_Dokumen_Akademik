...
<div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 mb-8">
    ...
    <p class="text-slate-500">Data statistik berikut menyajikan visualisasi distribusi dokumen dan tingkat keaktifan pengguna secara keseluruhan.</p>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="w-full bg-slate-100 rounded-full h-3">
                    <div class="bg-indigo-500 h-3 rounded-full" style="width: {{ $stats['total_documents'] > 0 ? ($cat->documents_count / $stats['total_documents']) * 100 : 0 }}%"></div>
                </div>
            </div>
            @endforeach
        </div>
        <div class="flex flex-col justify-center items-center p-8 bg-slate-50 rounded-2xl">
            ...
            <div class="text-center">
                <p class="text-4xl font-black text-slate-900">{{ $stats['total_uploads'] + $stats['total_downloads'] }}</p>
