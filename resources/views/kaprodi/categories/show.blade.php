...
<div class="space-y-5 pb-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-1.5 text-xs text-gray-400">
            ...
            <a href="{{ route('kaprodi.categories.index') }}" class="hover:text-gray-600 transition">Daftar Kategori</a>
            <span class="material-symbols-outlined !text-[13px]">chevron_right</span>
    ...
    <div class="card px-6 py-5">
        <div class="flex items-start gap-4">
            <div class="w-12 h-12 rounded-xl bg-violet-50 border border-violet-100 flex items-center justify-center flex-shrink-0">
                <span class="material-symbols-outlined text-violet-500 !text-[22px]">folder</span>
            </div>
            <div class="flex-1">
                <h1 class="text-xl font-semibold text-gray-900 tracking-tight">{{ $category->name }}</h1>
                <p class="text-sm text-gray-400 mt-0.5">
                    Dibuat pada {{ $category->created_at->translatedFormat('d F Y') }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="stat-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-semibold text-gray-900">{{ $category->documents_count }}</p>
    ...
    <div class="card overflow-hidden">
        ...
        <div class="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-gray-700">Dokumen dalam Kategori</span>
            </div>
                        ...
                        <tr>
                            <td colspan="6" class="py-16 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-400">Belum ada dokumen dalam kategori ini</p>
                                        <p class="text-xs text-gray-300 mt-0.5">Dokumen akan muncul setelah ada unggahan</p>
                                    </div>
                                </div>
                            </td>
                        </tr>
