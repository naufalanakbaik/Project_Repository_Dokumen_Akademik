...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-3">
            <div>
                <h2 class="text-lg font-semibold text-gray-800">Log Aktivitas Pengguna</h2>
                <p class="text-sm text-gray-500">Riwayat aktivitas terbaru pengguna dalam sistem</p>
            </div>
                    ...
                    @forelse($userActivities as $log)
                        <tr class="border-b hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-2">
                                ...
                                @if ($log->action === 'upload') bg-green-100 text-green-700
                                @elseif($log->action === 'download') bg-blue-100 text-blue-700
