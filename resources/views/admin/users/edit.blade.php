                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ $user->name }}"
                                class="w-full px-4 py-2.5 text-sm rounded-lg focus:ring-2 border border-gray-400
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password"
                                    class="w-full px-4 py-2.5 text-sm border border-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
