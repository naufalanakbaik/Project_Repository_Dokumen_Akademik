            ...
            <div class="max-w-3xl">
                ...
                <div class="mt-10 flex flex-wrap items-center gap-6 text-[12px] text-gray-800">
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full ring-1 ring-white bg-green-500"></span>
                        Akses Cepat
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full ring-1 ring-white bg-yellow-500"></span>
                        Repository Terpusat
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="w-2 h-2 rounded-full ring-1 ring-white bg-blue-500"></span>
                        Tampilan Modern
                    </div>
                </div>
            </div>
