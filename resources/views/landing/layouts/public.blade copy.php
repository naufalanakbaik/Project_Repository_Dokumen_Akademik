...
<body class="bg-gray-50 text-gray-800 antialiased scroll-smooth">
    ...
    {{-- Navbar --}}
    <nav
        class="sticky top-0 z-50 border-b border-gray-200/80 bg-white/90 backdrop-blur-xl supports-[backdrop-filter]:bg-white/70">
        ...
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            {{-- <div class="hidden md:flex items-center gap-8 text-sm">
                <a href="{{ route('landing') }}"
                    class="transition
                    {{ request()->routeIs('landing') ? 'text-blue-600 font-semibold' : 'text-gray-600 hover:text-blue-600' }}">
                    Beranda
                </a>

                <a href="{{ route('repository') }}"
                    class="transition
                    {{ request()->routeIs('repository*') ? 'text-blue-600 font-semibold' : 'text-gray-600 hover:text-blue-600' }}">
                    Repository
                </a>
            </div> --}}
            ...
            <div class="flex items-center gap-1">
                ...
                <a href="{{ route('login') }}"
                    class="px-4 py-2 text-[13px] font-medium text-gray-600 hover:text-blue-600 transition">
                    Masuk
                </a>

                <a href="{{ route('login') }}"
                    class="px-4 py-2 rounded-lg bg-amber-50 hover:bg-amber-100 text-amber-500 border border-amber-200 
