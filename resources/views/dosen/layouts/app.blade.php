    ...
    <div id="mobileSidebar" class="fixed top-0 left-0 bottom-0 z-[70] w-[280px] bg-white shadow-2xl -translate-x-full transition-transform 
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <div class="pt-4 mt-4 border-t border-gray-100">
                ...
                <a href="{{ route('dosen.profile.show') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-600 hover:bg-gray-50">
                    <span class="material-symbols-outlined !text-[20px]">person</span>
                    Profil Saya
                </a>
                <a href="{{ route('dosen.katalog.favorites') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-600 hover:bg-gray-50">
