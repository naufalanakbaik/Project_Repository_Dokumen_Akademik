    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-6 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('dosen.profile.edit') }}"
                class="inline-flex items-center justify-center gap-1.5 text-[12px] font-medium text-gray-500 hover:text-gray-700 border border-gray-300 
                px-4 py-2 rounded-lg bg-white hover:bg-gray-50 transition w-full sm:w-auto shadow-sm">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                    ...
                    <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div
                                    class="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-blue-100 border-4 border-white flex items-center justify-center shadow-sm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 flex sm:flex-col items-center justify-between sm:justify-center text-left sm:text-center hover:shadow-sm transition">
                ...
                <p class="text-lg font-semibold text-emerald-600 order-1 sm:order-2">
                    {{ $approved }}
                </p>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-4 flex sm:flex-col items-center justify-between sm:justify-center text-left sm:text-center hover:shadow-sm transition">
                ...
                <p class="text-lg font-semibold text-amber-600 order-1 sm:order-2">
                    {{ $pending + $rejected }}
                </p>
            </div>
