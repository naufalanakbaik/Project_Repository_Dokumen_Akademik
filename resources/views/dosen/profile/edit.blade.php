        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="bg-white border border-gray-200 rounded-lg p-5">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    {{-- Avatar --}}
                    <div
                        class="w-16 h-16 rounded-full bg-yellow-100 border border-yellow-300 flex items-center justify-center text-lg font-semibold font-serif text-yellow-600">
        ...
        <div class="col-span-12 lg:col-span-8 space-y-5">
            ...
            <form method="POST" action="{{ route('dosen.profile.update') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between pt-2 pb-2">
                    <a href="{{ route('dosen.profile.show') }}" class="text-[13px] text-gray-500 hover:text-gray-700">
                        Batal
                    </a>
                    <button
