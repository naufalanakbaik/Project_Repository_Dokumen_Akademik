...
@section('content')
 ...
 Broadway
        ...
        <div class="bg-white border border-amber-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div class="flex flex-row items-center justify-between p-4 sm:p-5 border-b border-amber-100 bg-amber-50 gap-4">
                ...
                {{-- Status published --}}
                <div class="flex items-center gap-1.5 px-2 py-1 sm:px-2.5 sm:py-1 rounded-2xl border border-emerald-200
 ...
 Broadway
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
